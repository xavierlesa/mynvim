...
-- Funcionnes propias y helpers - no plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        pylsp = {
          ...
          cmd = {"/usr/local/bin/pylsp", "--log-file=/tmp/pylsp.log", "-v" },
          settings = {
            pylsp = {
              plugins = {
                black = { enabled = true, virtualenv = true, line_length = 80 },
                isort = { enabled = true, virtualenv = true, line_length = 80 },
